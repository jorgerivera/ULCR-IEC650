...
\begin{frame}{Cronograma}
 ...
 {\small
  \begin{tabular}{|c|c|c|}\hline
   ...
   1 		& Intro y Revisión del programa & Práctica 1\\ \hline
   2 		& Arduino: C++ y puerto serie   & Charla + Práctica 2 \\ \hline
   3 		& Arduino: C++ y puerto serie	& Práctica 2 \\ \hline
   4 		& Arduino: Memorias		& Charla + Práctica 3  \\ \hline
   5		& Arduino: Memorias   	& Práctica 3  \\ \hline
   6 		& Arduino: Máquinas de estados		& Charla + Práctica 4  \\ \hline
