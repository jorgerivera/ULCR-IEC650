...
\begin{itemize}
	\item Crear un listado de 4 mensajes que se van a escribir en la pantalla de LCD, con los nombres \texttt{msjUno}, \texttt{msjDos}, \texttt{msjTres}, \texttt{msjCuatro}.
    \item Mostrar en la pantalla LCD uno de los mensajes.
    \item Usar una estructura similar a la creada en el laboratorio 3 que permita seleccionar uno de los mensajes para ser mostrados en el LCD.
    \item al seleccionar una de las opciones, se deberá mostrar en el LCD el mensaje correspondiente.
\end{itemize}
