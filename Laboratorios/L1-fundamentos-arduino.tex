...
Esta práctica será realizada enteramente en el laboratorio. Cada estudiante realizará un pequeño circuito con leds, utilizando una tarjeta Arduino.
...
\begin{itemize}
	\item Conectar correctamente al menos cinco leds.
	\item Conectar correctamente un interruptor.
    \item Realizar una secuencia de encendido/apagado en los cinco leds.
    \item Realizar otra secuencia diferente de encendido/apagado en los cinco leds.
    \item Leer el estado de un interruptor.
    \item Mostrar una de las secuencias cuando el interruptor está presionado y la otra cuando está suelto.
\end{itemize}
