...
Esta práctica será realizada enteramente en el laboratorio. Cada estudiante realizará un pequeño circuito con un interruptor y leds, utilizando una tarjeta Arduino.
...
\begin{itemize}
	\item Mostrar la lista de opciones o menú en el puerto serie primario.
	\item Recibir un dato en el puerto serie primario.
	\item Procesar el dato recibido y actuar de acuerdo al protocolo discutido en la clase. 
	\item Para los ``comandos'' que cambian el estado de los LEDs, deberá ejecutarse dicha acción.
	\item Para el ``comando'' que envía un mensaje, deberá capturarse el mensaje (terminado con un salto de línea) y retransmitirse por un puerto serial secundario.	
	\item Enviar una respuesta por el puerto serie primario.
\end{itemize}
