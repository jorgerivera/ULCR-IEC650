...
\textbf{Nota:} el Arduino Due no podrá ser utilizado para esta práctica, ya que carece de EEPROM.
...
\begin{enumerate}
	\item Arreglos de variables.
	\item Funciones de la librería \texttt{EEPROM} (\texttt{read()} y \texttt{write()}).
	\item Variables tipo \texttt{String} y funciones relacionadas.
\end{enumerate}
...
\begin{center}
 \begin{tabular}{p{0.35\textwidth}|c}\hline
   ...
   Descripción de los programas			& 30\% \\\hline
